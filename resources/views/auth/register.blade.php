        ...
        <div class="rounded shadow">
            ...
            <div class="bg-white p-3 rounded-b">
                <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex items-stretch mb-3">
                        <label for="account_name" class="text-right font-semibold text-grey-dark text-sm pt-2 pr-3 align-middle w-1/4">Account</label>
                        <div class="flex flex-col w-3/4">
                            <input id="account_name" type="text" class="flex-grow h-8 px-2 border rounded {{ $errors->has('account_name') ? 'border-red-dark' : 'border-grey-light' }}" account_name="account_name" value="{{ old('account_name') }}" autofocus>
